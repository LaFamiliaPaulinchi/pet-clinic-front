...
export const PetForm: React.FC<PetFormProps> = ({ 
  ...
  const selectedGuardian = guardians.find(g => g.id === formData.guardianId);
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Type at least 3 characters to search guardian..."
                value={searchTerm}
                ...
                {filteredGuardians.map((guardian) => (
                  <label
                    ...
                    className={`flex items-center p-2 hover:bg-gray-50 cursor-pointer ${
                      formData.guardianId === guardian.id ? 'bg-blue-50' : ''
                    }`}
                  >
                    <input
                      type="radio"
                      name="guardian"
                      value={guardian.id}
                      checked={formData.guardianId === guardian.id}
